...
namespace ltn::c {
	...
	const Table table{
		...
		{"io_print",                 vm_build_in<FxCode::PRINT>},
		{"io_read",                  vm_build_in<FxCode::READ_STR>},
		{"io_read_str",              vm_build_in<FxCode::READ_STR>},
		{"io_readln",                vm_build_in<FxCode::READ_LINE>},
		{"io_read_bool",             vm_build_in<FxCode::READ_BOOL>},
		{"io_read_char",             vm_build_in<FxCode::READ_CHAR>},
		{"io_read_int",              vm_build_in<FxCode::READ_INT>},
		{"io_read_float",            vm_build_in<FxCode::READ_FLOAT>},
