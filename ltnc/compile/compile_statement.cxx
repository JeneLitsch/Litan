#include "compile.hxx"
namespace ltn::c {
	StmtResult compile_stmt(const ast::StatementExpression & stmt, CompilerInfo & info, Scope & scope) {
	...
	StmtResult compile_stmt(const ast::DoNothing & stmt, CompilerInfo & info, Scope & scope) {
		return StmtResult{{}, 0};
	}
