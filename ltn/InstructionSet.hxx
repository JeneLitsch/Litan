...
namespace ltn {
	enum class Inst : std::uint8_t {
		...
		JUMP = 0x40, CALL, RETURN, IF, INVOKE, EXTERNAL, CAPTURE, PARAMETERS,

		NEWARR = 0x50, NEWSTR, NEWOUT, NEWIN, NEWFX, NEWCLOCK, NEWSTRUCT,
		...
		CAST_INT = 0xb0, CAST_FLOAT, CAST_STRING, CAST_BOOL,
